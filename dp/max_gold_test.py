...
class MaxGoldTestCase(unittest.TestCase):
    ...
    def testGetMax2(self):
        ...
        self.assertEqual(17, m.get_max2([8, 0, 8, 0, 0, 8, 0, 8, 1]))
        self.assertEqual(17, m.get_max2([1, 7, 2, 7, 3, 8]))
    ...
    def testGetMaxCached(self):
        self.assertEqual(17, m.get_max_cached([10, 8, 7, 1, 8]))
